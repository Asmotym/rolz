...
const docsUrl = import.meta.env.VITE_API_DOCS_URL || 'https://docs.aventyr.io';
const apiBaseUrl = import.meta.env.VITE_PUBLIC_API_BASE_URL || 'https://api.aventyr.io/api';
